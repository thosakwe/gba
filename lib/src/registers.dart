...
class Registers {
  final ByteData _byteData =
      new ByteData.view(new Uint8List(16).buffer); // 16 8-bit registers?
  ...
  int get BC => _byteData.getUint16(1);
  ...
  int get DE => _byteData.getUint16(3);

  void set D(int value) => _byteData.setUint8(3, value);

  void set DE(int value) => _byteData.setUint16(3, value);
  ...
  int get HL => _byteData.getUint16(6);

  void set H(int value) => _byteData.setUint8(6, value);

  void set HL(int value) => _byteData.setUint16(6, value);
